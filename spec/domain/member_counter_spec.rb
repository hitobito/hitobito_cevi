...
describe 'MemberCounter' do
  ...
  before do
    jungschar1_gruppe1 = groups(:jungschar_zh10_aranda)
    jungschar1_gruppe2 = groups(:jungschar_zh10_salomo)
    ...
    Fabricate(Group::Stufe::Stufenleiter.name, group: jungschar1_gruppe1,
              person: Fabricate(:person, gender: 'm', birthday: '1988-01-01'))
    Fabricate(Group::Stufe::Teilnehmer.name, group: jungschar1_gruppe1,
              person: Fabricate(:person, gender: 'w', birthday: '1999-02-02'))
    Fabricate(Group::Stufe::Teilnehmer.name, group: jungschar1_gruppe2,
    ...
    old = Fabricate(Group::Stufe::Stufenleiter.name, group: jungschar1_gruppe2,
