...
=== Cevi Organization Hierarchy
    ...
    * Mitgliederorganisation
      ...
      * Geschäftsstelle
        ...
        * Administrator/-in Ortsgruppen: [:layer_and_below_full, :manage_invisible_people, :finance]
      * Gremium
    ...
    * Ortsgruppe
      * Ortsgruppe
        * Administrator/-in Cevi DB: [:layer_and_below_full, :manage_invisible_people]
        * Kassier: [:layer_and_below_read, :finance]
    * Jungschar
      * Jungschar
